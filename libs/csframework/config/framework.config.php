...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      'type'    => 'content',
      'content' => 'Codestar Framework is <strong>free</strong> to use both personal and commercial. If you used commercial, <strong>please credit</strong>. Read more about <a href="'.get_permalink().'" target="_blank">GNU License</a>',
    ),
